...
const buttons = document.querySelectorAll('#flipbook-html-overlay .book-controls button');
...
// Additionally ensure the parent container isn't blocking interactions
const overlayContainer = document.getElementById('flipbook-html-overlay');
if (overlayContainer) {
    overlayContainer.style.pointerEvents = 'auto';
}

// Also explicitly enabling CSS touch interactions (insert this CSS fix)
const cssTouchFix = document.createElement('style');
cssTouchFix.textContent = `
    #flipbook-html-overlay, 
    #flipbook-html-overlay * {
...
`;
document.head.appendChild(cssTouchFix);